...
const useUserManagement = () => {
  ...
  const createNewUser = async () => {
    ...
    try {
      const response = await axios.post("https://whatsapp-multi-session-qr.onrender.com/api/user/create", {
  ...
  const deleteUser = async (userId) => {
    ...
    try {
      await axios.delete(`https://whatsapp-multi-session-qr.onrender.com/api/user/${userId}`);
